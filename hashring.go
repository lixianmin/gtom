...
func NewWithHash(nodes []string, hasher hash.Hash) (*HashRing, error) {
	return Nnew(nodes, make(map[string]int), hasher)
}
...
func NewWithHashAndWeights(weights map[string]int, hasher hash.Hash) (*HashRing, error) {
	...
	return Nnew(nodes, weights, hasher)
}
...
func Nnew(nodes []string, weights map[string]int, hasher hash.Hash) (*HashRing, error) {
	if hasher == nil {
